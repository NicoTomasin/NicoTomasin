        ...
        <div className="fixed bottom-0 left-0 p-4 bg-black rounded-md bg-clip-padding backdrop-filter backdrop-blur-2xl bg-opacity-10 z-50 border border-cyan-400">
          <div className="mb-4">
            ...
            >
              <svg
                ...
                className="icon icon-tabler icon-tabler-brand-github hover:scale-105 transition animate-fade-up animate-duration-600 animate-ease-out hover:text-white text-cyan-400 cursor-pointer"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                strokeWidth="2"
          ...
          <div className="mb-4">
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="icon icon-tabler icon-tabler-brand-linkedin transition animate-fade-up animate-duration-600 animate-ease-out hover:text-white text-cyan-400 cursor-pointer"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                strokeWidth="2"
          ...
          <div>
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="icon icon-tabler icon-tabler-brand-x hover:scale-105 transition animate-fade-up animate-duration-600 animate-ease-out hover:text-white text-cyan-400 cursor-pointer"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                strokeWidth="2"
